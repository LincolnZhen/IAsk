...
<script type="text/javascript"
	src="<%=path%>/bootstrap3.3.7/js/bootstrap.js"></script>
...
<body style="background-image: url(images/back.jpg)">
	...
	<div class="header" id="header">
		<nav class="navbar" role="navigation" style="height: 105px">
			...
			<div id="avatar" class="geren"
				style="margin-left: 550px; margin-top: 70px;">
	...
	<div class=" tab-content "
		style="height: 900px; margin-top: 80px; background-color: white; width: 1170px; margin-left: 170px;">
